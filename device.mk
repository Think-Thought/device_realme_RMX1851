...
# IRQBalance
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/perf/msm_irqbalance.conf:$(TARGET_COPY_OUT_VENDOR)/etc/perf/msm_irqbalance.conf
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/perf/powerhint.json:$(TARGET_COPY_OUT_VENDOR)/etc/perf/powerhint.json
